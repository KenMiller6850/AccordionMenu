                                        ...
                                        with a.ul(klass='menu vertical nested'):
                                            ...
                                            with a.li():
                                                ...
                                                while i < len(dfExtractedTables.index):
                                                   ...
                                                   ChangedFlag = dfExtractedTables.iloc[i, dfExtractedTables.columns.get_loc('ChangedFlag')]
                                                   
                                                   if ChangedFlag == 0:
                                                      with a.a("href='User_databases\\NRTCUSTOMDB\\Tables\\" +  TableName + ".html', target='DATA'"):
                                                        a(SchemaName + '.' + TableName)
                                                   
                                                   if ChangedFlag == 1:                                                
                                                      with a.a("href='User_databases\\NRTCUSTOMDB\\Tables\\" +  TableName + ".html', target='DATA' class="newanchor"):
                                                        a(SchemaName + '.' + TableName)
...
with open('C:\\Users\\akdmille\\Documents\\My Database Documentation\\FileTesting3\\index3.html', 'wb') as f:
